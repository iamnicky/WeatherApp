...
export default function Quote() {
    const clicked = () => {
        alert("Will change the quote on clicking this button!")
    }
    return (
        <div className='bg-violet-600 h-[100vh] w-[600px]'>
            ...
            <button onClick={clicked} className='bg-black text-white ml-16 mt-32 px-8 py-4 rounded-2xl text-lg'>Next Quote</button>
