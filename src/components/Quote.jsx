 ...
 getQuote();
    ...
    return (
        <div className=' h-[100vh] w-[600px]'>
            ...
            <p className='font-mono mt-12 ml-16 text-gray-900'><span className='font-bold text-xl'>Quote of the day : </span><span className='text-grey-500 text-xl italic hover:not-italic '>{quote.text}</span></p>
